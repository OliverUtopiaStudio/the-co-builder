...
export default function StudioOverviewPage() {
  ...
  const totalCurrent = kpis.slice(0, 7).reduce((s, k) => s + k.current, 0);
  const totalTarget = kpis.slice(0, 7).reduce((s, k) => s + k.target, 0);
  ...
  return (
    <div>
      ...
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-medium text-foreground">KPI Scoreboard</h1>
        <div className="flex items-center gap-3 mt-2">
          <p className="text-sm text-muted">
            Year 1 targets — {totalCurrent}/{totalTarget} metrics achieved across 7 KPIs
          </p>
          <button
